...
export const edgeGuidance = [
  {
    id: "porcelain-double-bevel",
    name: "Double Bevel",
    recommendation: "StoneMatch's standard recommendation for porcelain is a simple double bevel.",
    suitableMaterials: ["Porcelain"],
    recommendedThickness: "Standard porcelain edge",
    positioning: "Porcelain has a plain exposed edge, so a simple, clean double bevel keeps the detail understated and lets the worktop surface speak for itself.",
    premium: false,
  },
  {
    id: "20mm-bullnose",
    name: "Bullnose",
    recommendation: "A premium rounded edge option for 20mm Quartz, Granite or Marble.",
    suitableMaterials: ["Quartz", "Granite", "Marble"],
    recommendedThickness: "20mm",
    positioning: "A softer, more traditional premium finish when the customer wants more edge detail.",
    premium: true,
  },
  {
    id: "20mm-sharknose",
    name: "Shark Nose",
    recommendation: "A premium contemporary edge that works particularly well with handleless kitchens.",
    suitableMaterials: ["Quartz", "Granite", "Marble"],
    recommendedThickness: "20mm",
    positioning: "Creates a slimmer visual line and complements clean, contemporary and handleless cabinetry.",
    premium: true,
  },
  {
    id: "20mm-double-bevel",
    name: "Double Bevel",
    recommendation: "A clean StoneMatch-recommended finish for 20mm stone.",
    suitableMaterials: ["Quartz", "Granite", "Marble"],
    recommendedThickness: "20mm",
    positioning: "Simple and crisp, keeping attention on the material rather than the edge detail.",
    premium: false,
  },
  {
    id: "20mm-double-pencil",
    name: "Double Pencil",
    recommendation: "A softer alternative to a Bullnose without the premium-edge cost.",
    suitableMaterials: ["Quartz", "Granite", "Marble"],
    recommendedThickness: "20mm",
    positioning: "A practical choice for customers who want a softened edge while keeping fabrication simpler than a Bullnose.",
    premium: false,
  },
  {
    id: "30mm-double-bevel",
    name: "Double Bevel",
    recommendation: "StoneMatch's standard recommendation for 30mm Quartz, Granite or Marble.",
    suitableMaterials: ["Quartz", "Granite", "Marble"],
    recommendedThickness: "30mm",
    positioning: "With a 30mm worktop the material already has a substantial appearance, so the clean double bevel lets the thickness and the stone itself do the talking.",
    premium: false,
  },
  {
    id: "ogee",
    ...
    suitableMaterials: ["Quartz", "Granite", "Marble"],
    recommendedThickness: "30mm",
    positioning: "A premium traditional decorative detail for classic and luxury kitchens.",
    premium: true,
  },
  {
