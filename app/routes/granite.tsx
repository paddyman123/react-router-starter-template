...
<section className="section light"><div className="shell split"><div><p className="eyebrow dark">StoneMatch it</p><h2>Already found<br/><em>your Granite?</em></h2></div><div className="reason-copy dark-copy"><p>Send us the slab details, kitchen plan or existing quotation. We will compare suitable fabrication routes and the complete installed price to help you get the Granite you want for better value.</p><a className="button gold" href="/?material=Granite#enquire">Find my Granite saving →</a></div></div></section>
</Page>}
