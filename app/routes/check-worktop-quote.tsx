...
export function meta(){return [{title:"Save Money on Your Worktop Quote | StoneMatch"},{name:"description",content:"Already have a kitchen worktop quote or kitchen plan? Send it to StoneMatch for a free, no-obligation check of the material, specification and overall value before you commit."}]}
...
<div className="shell enquiry-head"><p className="eyebrow dark">Free savings check</p><h2>Send us what <em>you have.</em></h2><p>Already have a quotation? Add the details below. Only have kitchen plans or measurements? That's fine too. The form takes around two minutes.</p></div>
