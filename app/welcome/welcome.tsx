...
export function Welcome({ message: _message }: { message: string }) {
	return (
		<main>
			...
			<section id="top" className="hero"><div className="hero-glow"/><div className="shell hero-grid"><div className="hero-copy"><p className="eyebrow">Independent worktop sourcing & quote check</p><h1>Before you buy your worktops.<br/><em>StoneMatch them.</em></h1><p className="lead">Already have a worktop quote? Let us check it before you pay the deposit. Starting from scratch? Tell us what you're looking for and we'll help find the right route.</p><p>StoneMatch uses industry knowledge and a network of reputable fabricators to help you make a better-informed choice on material, supplier and price.</p><div className="hero-actions"><a className="button gold" href="#enquire">Check my worktop quote</a><a className="text-link" href="#enquire">Find my worktop <span>→</span></a></div><div className="trust"><span>✓ Free for homeowners</span><span>✓ Reputable fabricators</span><span>✓ No obligation</span></div></div><div className="stone-card"><div className="stone-surface"><div className="vein v1"/><div className="vein v2"/><div className="vein v3"/></div><div className="stone-caption"><small>THE STONEMATCH QUOTE CHECK</small><strong>Got a quote? Check it before you commit.</strong><span>Material · Specification · Fabrication · Price</span></div></div></div></section>
