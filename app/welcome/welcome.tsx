...
<header className="site-header home-header"><nav className="nav shell home-nav"><Brand/><div className="nav-links"><a className="shortlist-nav" href="/shortlist">Shortlist</a><a className="start-match" href="/guides/check-my-worktop-quote#check-my-quote">Check my quote</a></div></nav><div className="shell"><PrimaryTabs/></div></header>

<section id="top" className="hero"><div className="hero-glow"/><div className="shell hero-grid"><div className="hero-copy"><p className="eyebrow">Independent worktop quote check & sourcing</p><h1>Before you buy your worktops.<br/><em>StoneMatch them.</em></h1><p className="lead">Got a quote? We'll check the stone, specification, supplier and price before you commit. No quote yet? We'll help you find the right option.</p><div className="hero-actions"><a className="button gold" href="/guides/check-my-worktop-quote#check-my-quote">Check my quote</a><a className="text-link" href="/materials">Explore materials <span>→</span></a></div><div className="trust"><span>✓ Free for homeowners</span><span>✓ Independent guidance</span><span>✓ No obligation</span></div></div><div className="stone-card"><div className="stone-surface"><div className="vein v1"/><div className="vein v2"/><div className="vein v3"/></div><div className="stone-caption"><small>THE STONEMATCH CHECK</small><strong>Check before you commit.</strong><span>Stone · Specification · Supplier · Price</span></div></div></div></section>
...
<section id="why" className="section dark-section"><div className="shell split"><div><p className="eyebrow">Why StoneMatch?</p><h2>A worktop quote is more<br/>than <em>just a price.</em></h2></div><div className="reason-copy"><p>Material, fabrication, installation and service can vary significantly between quotes.</p><p><strong>We help you compare like-for-like and understand where the real value is.</strong></p><a className="text-link gold-text" href="/why-stonematch">Why use StoneMatch? <span>→</span></a></div></div></section>

<section className="section light"><div className="shell split"><div><p className="eyebrow dark">Our promise</p><h2>Already got a good deal?<br/><em>We'll tell you.</em></h2></div><div className="reason-copy dark-copy"><p>We're here to help you make the right choice, not simply sell you a different one.</p><a className="button gold" href="/guides/check-my-worktop-quote#check-my-quote">StoneMatch my quote</a></div></div></section>

<section id="enquire" className="section enquiry"><div className="shell enquiry-head"><p className="eyebrow dark">Starting from scratch?</p><h2>Tell us about <em>your project.</em></h2><p>No quote yet? Send us your plans, measurements or ideas and we'll help you find the right starting point.</p></div><div className="shell"><MatchWizard/></div></section>
<Footer/>
</main>}